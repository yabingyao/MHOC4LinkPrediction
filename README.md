...
> Tips: we computes the high-order clustering structure of nodes with the aid of [HigherOrderClustering](http://snap.stanford.edu/hocc/) from [HERE](https://github.com/arbenson/HigherOrderClustering.jl).
